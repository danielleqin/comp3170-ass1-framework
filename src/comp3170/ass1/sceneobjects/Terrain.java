...
public class Terrain extends SceneObject {
	...
	private float[] vertices = new float[] { -1.0f, 0.0f, 1.0f, 0.0f, 1.0f, 2.0f,

			1.0f, 2.0f, -1.0f, 2.0f, -1.0f, 0.0f };;
	private int vertexBuffer;

	private float[] roofVertices = new float[] { 0.0f, 4.0f, -1.6f, 2.0f, 1.6f, 2.0f, };
